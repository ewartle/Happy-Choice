# ![Logo](/client/public/happy-choice-logo.png)  Happy Choice   #
### **The Creators:**  
...
3) Navigate to the Happy Choice directory, and clone the GitHub directory to your local machine by running the following command:  
   ```
   git clone "https://github.com/ewartle/Happy-Choice.git"
   npm install
   ```    
3) Launch the program locally with the following command:  
   `npm run dev`      
